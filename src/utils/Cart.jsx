            ...
            <div className="p-4 md:p-6 space-y-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <button className="w-full bg-red-600 text-white px-6 py-3 rounded-lg font-medium flex items-center justify-center gap-2">
                    <FiXCircle className="text-xl" /> Clear Cart
                  </button>

                  <button className="w-full bg-indigo-600 text-white px-6 py-3 rounded-lg font-medium flex items-center justify-center gap-2">
